...
function showHelp() {
	...
	$("#inst_main_body").html("<div id='instructions_head'>如何遊玩？</div> <p>Hextris 的目標是阻止方塊離開外圍灰色六角形的內側。</p> <p>在電腦上,按右左方向鍵來控制遊戲;在手機上,輕觸左右側即可旋轉六角形。</p> <p>消除三個或更多相同顏色的方塊可以獲得分數。</p> <p>外圍六角形上的有色線條表示您的連擊時間還剩多久會消失。</p> <hr> <p id='afterhr'></p> 由 <a href='http://loganengstrom.com' target='_blank'>Logan Engstrom</a> 和 <a href='http://github.com/garrettdreyfus' target='_blank'>Garrett Finucane</a> 製作。 在 <a href='https://itunes.apple.com/us/app/id903769553?mt=8' target='_blank'>iOS</a> 和 <a href='https://play.google.com/store/apps/details?id=com.hextris.hextris' target='_blank'>Android</a> 上均可下載。 更多資訊請至 <a href='http://hextris.github.io/' target='_blank'>Hextris 網站</a>");
	if (gameState == 1) {
		pause();
	}
