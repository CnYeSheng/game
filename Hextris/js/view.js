...
function showText(text) {
	var messages = {
		'paused': "<div class='centeredHeader unselectable'>遊戲暫停</div>",
		'pausedAndroid': "<div class='centeredHeader unselectable'>遊戲暫停</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:300px;font-size:16px;'></div>",
		'pausediOS': "<div class='centeredHeader unselectable'>遊戲暫停</div><div class='unselectable centeredSubHeader' style='position:absolute;margin-left:-150px;left:50%;margin-top:20px;width:300px;font-size:16px;'></div>",
		'pausedOther': "<div class='centeredHeader unselectable'>遊戲暫停</div><div class='unselectable centeredSubHeader' style='margin-top:10px;position:absolute;left:50%;margin-left:-190px;max-width:380px;font-size:18px;'></div>",
		'start': "<div class='centeredHeader unselectable' style='line-height:80px;'>按下 Enter 開始遊戲</div>"
	};
