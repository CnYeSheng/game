...
var precacheConfig = [
		["./dist/bundle.js", "e3a191a96f0a962fcb4549feb215b8b9"],
		["./dist/vendor.bundle.js", "70b1488646725bb988057ec50aa8e6a9"],
		["assets/images/explosion.png", "4526e7f626ed39938e5d1c422818ac31"],
		["assets/sounds/empty.mp3", "17e1b96e76bb7d94a541c5393133793d"],
		["assets/sounds/explosion.mp3", "77cb111184095a4ccf6b17fef0a94395"],
		["assets/sounds/init.mp3", "f148d8541953755eff0e8163e03e748f"],
		["assets/sounds/lose.mp3", "70be8033b8ae406f08d98829436bfbd2"],
		["assets/sounds/mark.mp3", "60e88bea58d5ec0ba1e3b418509d7477"],
		["assets/sounds/reveal.mp3", "fbee03cd6c2f56e51301ea8698fecb9c"],
		["assets/sounds/win.mp3", "e17aa7465b67967051634c5e96350989"],
		["favicon.ico", "8114d0895f00c69058190a2645c8988c"],
		["index.html", "8485744136b57e4569e8fbcaa35d5b44"],
		["manifest.json", "1868f7ef4fca9e46dd66fb4ff49f5a05"]
	],
	cacheName = "sw-precache-v3-minesweeper-" + (self.registration ? self.registration.scope : ""),
...
self.addEventListener("install", function(e) {
	...
	function(e) {
		...
		return function e(t, n, r) {
			...
			1: [function(e, t, n) {
				function r(e, t) {
					((t = t || {}).debug || u.debug) && console.log("[sw-toolbox] " + e)
				}

				function o(e) {
					var t;
					return e && e.cache && (t = e.cache.name), t = t || u.cache.name, caches.open(t)
				}
				...
				function a(e, t, n) {
					var o = e.url,
						...
						i = n.name,
						c = Date.now();
					return r("Updating LRU order for " + o + ". Max entries is " + a + ", max age is " + s), f.getDb(i).then(function(e) {
						return f.setTimestampForUrl(e, o, c)
					}).then(function(e) {
						return f.expireEntries(e, a, s, c)
					}).then(function(e) {
				...
				t.exports = {
					...
					precache: function(e) {
						e instanceof Promise || i(e), u.preCacheItems = u.preCacheItems.concat(e)
					},
			...
			2: [function(e, t, n) {
				...
				function o(e, t, n) {
					return t ? new Promise(function(r, o) {
						var s = 1e3 * t,
							...
							h = i.objectStore(c);
						h.index(f).openCursor().onsuccess = function(e) {
							var t = e.target.result;
							if (t && n - s > t.value[f]) {
								var r = t.value[u];
								a.push(r), h.delete(r), t.continue()
							}
					...
					return t ? new Promise(function(n, r) {
						...
						i.count().onsuccess = function() {
							...
							e > t && (i.openCursor().onsuccess = function(n) {
								...
								if (r) {
									var s = r.value[u];
									o.push(s), a.delete(s), e - o.length > t && r.continue()
								}
							})
				...
				t.exports = {
					getDb: function(e) {
						return e in h || (h[e] = r(e)), h[e]
					},
					setTimestampForUrl: function(e, t, n) {
						return new Promise(function(r, o) {
							var s = e.transaction(c, "readwrite");
							s.objectStore(c).put({
								url: t,
								timestamp: n
							}), s.oncomplete = function() {
					...
					expireEntries: function(e, t, n, r) {
						return o(e, n, r).then(function(n) {
			...
			5: [function(e, t, n) {
				var r = new URL("./", self.location).pathname,
					o = e("path-to-regexp"),
					s = function(e, t, n, s) {
						t instanceof RegExp ? this.fullUrlRegExp = t : (0 !== t.indexOf("/") && (t = r + t), this.keys = [], this.regexp = o(t, this.keys)), this.method = e, this.options = s, this.handler = n
					};
			...
			6: [function(e, t, n) {
				...
				["get", "post", "put", "delete", "head", "any"].forEach(function(e) {
				...
				}), i.prototype.add = function(e, t, n, a) {
					a = a || {};
					var i;
					t instanceof RegExp ? i = RegExp : (i = a.origin || self.location.origin, i = i instanceof RegExp ? i.source : r(i)), e = e.toLowerCase();
					var c = new o(e, t, n, a);
					...
					f.has(h.source) && s.debug('"' + t + '" resolves to same regex as existing route.'), f.set(h.source, c)
				...
				t.exports = function(e, t, n) {
					return n = n || {}, o.debug("Strategy: cache first [" + e.url + "]", n), o.openCache(n).then(function(t) {
						return t.match(e).then(function(t) {
							var s = n.cache || r.cache,
								a = Date.now();
							return o.isResponseFresh(t, s.maxAgeSeconds, a) ? t : o.fetchAndCache(e, n)
						})
					})
				}
			}, {
			...
			9: [function(e, t, n) {
				var r = e("../helpers"),
					o = e("./cacheOnly");
				t.exports = function(e, t, n) {
					return r.debug("Strategy: fastest [" + e.url + "]", n), new Promise(function(s, a) {
						var i = !1,
							c = [],
							u = function(e) {
								c.push(e.toString()), i ? a(new Error('Both cache and network failed: "' + c.join('", "') + '"')) : i = !0
							},
							f = function(e) {
								e instanceof Response ? s(e) : u("No result returned")
							};
			...
			11: [function(e, t, n) {
				var r = e("../options"),
					o = e("../helpers");
				t.exports = function(e, t, n) {
					var s = (n = n || {}).successResponses || r.successResponses,
								...
								i = setTimeout(function() {
									t.match(e).then(function(e) {
										var t = n.cache || r.cache,
											a = Date.now(),
											i = t.maxAgeSeconds;
										o.isResponseFresh(e, i, a) && s(e)
									})
								}, 1e3 * a)
							});
							u.push(f)
						}
						var h = o.fetchAndCache(e, n).then(function(e) {
							if (i && clearTimeout(i), s.test(e.status)) return e;
			...
			13: [function(e, t, n) {
				var r = e("./options"),
					...
					a = e("./strategies"),
					i = e("./listeners");
				s.debug("Service Worker Toolbox is loading"), self.addEventListener("install", i.installListener), self.addEventListener("activate", i.activateListener), self.addEventListener("fetch", i.fetchListener), t.exports = {
			...
			15: [function(e, t, n) {
				function r(e, t) {
					for (var n, r = [], o = 0, s = 0, a = "", u = t && t.delimiter || "/"; null != (n = v.exec(e));) {
						var f = n[0],
							h = n[1],
							l = n.index;
						if (a += e.slice(s, l), s = l + f.length, h) a += h[1];
						else {
							var p = e[s],
								d = n[2],
								m = n[3],
				...
				function a(e) {
					...
					return function(n, r) {
						for (var a = "", i = n || {}, c = (r || {}).pretty ? o : encodeURIComponent, u = 0; u < e.length; u++) {
							var f = e[u];
							if ("string" != typeof f) {
								var h, l = i[f.name];
								if (null == l) {
								...
								if (g(l)) {
									...
									for (var p = 0; p < l.length; p++) {
										if (h = c(l[p]), !t[u].test(h)) throw new TypeError('Expected all "' + f.name + '" to match "' + f.pattern + '", but received `' + JSON.stringify(h) + "`");
										a += (0 === p ? f.prefix : f.delimiter) + h
									}
								} else {
									if (h = f.asterisk ? s(l) : c(l), !t[u].test(h)) throw new TypeError('Expected "' + f.name + '" to match "' + f.pattern + '", but received "' + h + '"');
									a += f.prefix + h
								}
							} else a += f
						}
				...
				function d(e, t, n) {
					g(t) || (n = t || n, t = []);
					for (var r = (n = n || {}).strict, o = !1 !== n.end, s = "", a = 0; a < e.length; a++) {
						var c = e[a];
						if ("string" == typeof c) s += i(c);
						else {
							var h = i(c.prefix),
								l = "(?:" + c.pattern + ")";
							t.push(c), c.repeat && (l += "(?:" + h + l + ")*"), s += l = c.optional ? c.partial ? h + "(" + l + ")?" : "(?:" + h + "(" + l + "))?" : h + "(" + l + ")"
						}
					}
					var p = i(n.delimiter || "/"),
						d = s.slice(-p.length) === p;
					return r || (s = (d ? s.slice(0, -p.length) : s) + "(?:" + p + "(?=$))?"), s += o ? "$" : r && d ? "" : "(?=" + p + "|$)", u(new RegExp("^" + s, f(n)), t)
				}

				function m(e, t, n) {
					return g(t) || (n = t || n, t = []), n = n || {}, e instanceof RegExp ? h(e, t) : g(e) ? l(e, t, n) : p(e, t, n)
				}
				var g = e("isarray");
				t.exports = m, t.exports.parse = r, t.exports.compile = function(e, t) {
					return a(r(e, t))
	...
	}), toolbox.router.get(/assets\/fonts\/.*$/, toolbox.cacheFirst, {}), toolbox.router.get(/assets\/icons\/.*$/, toolbox.cacheFirst, {});